...
if __name__=='__main__':
    ...
    ParallelMC().run(prob=PROB, steps=options.steps, repeats=options.runs, run_cls=onedim.OneDimRun, smpl_classes=[current.IonCurrent], length=options.length, path=options.path)
